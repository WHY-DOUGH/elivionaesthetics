      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-background/70 leading-relaxed max-w-md mb-6">
              Experience the art of aesthetic enhancement at Elivion Aesthetics. 
              We combine advanced techniques with personalized care to help you 
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-background/70 text-sm">
                  2nd Floor, Park and Shop Incorporation,<br />
                  Dr Arcadio Santos Ave, Parañaque,<br />
                  1700 Metro Manila
                </span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                >
                  elivionaestheticclinic@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-background/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-background/50 text-sm">
            © {currentYear} Elivion Aesthetics. All rights reserved.
          </p>
          <p className="text-background/50 text-sm">
            Crafted with care for your beauty journey
          </p>
        </div>
      </div>
    </footer>
